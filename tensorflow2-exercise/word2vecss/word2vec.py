...
def word2vec():
    model = keras.Sequential([
        layers.Embedding(movieLens, embedding_dim, input_shape=2),
...
def word2vec1():
    ...
    x1 = layers.Embedding(output_dim=embedding_dim, input_dim=movieLens,
...
def word2vec2():
    ...
    x = layers.Embedding(output_dim=embedding_dim, input_dim=movieLens,
...
def main():
    model = word2vec1()
    train_dataset = get_dataset_from_csv(r"train_data.csv", shuffle=True, batch_size=128)
    test_dataset = get_dataset_from_csv(r"test_data.csv", batch_size=128)
